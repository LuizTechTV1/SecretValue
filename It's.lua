...
function library:CreateWindow(argstable)
    ...
    local hidebutton = argstable["Key"] or Enum.KeyCode.RightControl
    local window = { }
    ...
    function Tabs.CreateTab(name)
        ...
        local Sections = {}
        function Sections.CreateSector(name,side)
            local sector = { }
            sector.name = name or ""
            ...
            function Sections.AddButton(argstable)
        ...
        table.insert(window.Tabs, tab, Tabs)
        return tab
    end
